...
this.initTouchEvents = function () {
  this.$canv.ontouchstart = function (e) {
  ...
  this.$canv.ontouchmove = function (e) {
    e.preventDefault(); // Prevent scrolling when touching the canvas
    var touch = e.touches[0];
    this.mx = touch.clientX;
    this.my = touch.clientY;
  ...
  this.$canv.ontouchend = function (e) {
    e.preventDefault(); // Prevent scrolling when touching the canvas
    this.$canv.onmouseup();
  }.bind(this);
};

// Now call the function to initialize touch events
var particleSlider = new ParticleSlider({
  /* options */
});
particleSlider.initTouchEvents();
